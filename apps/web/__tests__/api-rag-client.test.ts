...
const response = { traceId: 'trace-1', state: 'ANSWERED' as const, answer: 'Active evidence says one hour.', citations: [{ evidenceId: 'chunk-1', sourceLogicalId: 'incident-response-policy', sourceTitle: 'Incident response policy', sourceType: 'html' as const, heading: 'Acknowledgement', section: null, page: null, anchor: 'acknowledgement', excerpt: 'The coordinator acknowledges the report within one business hour.' }], accountEvidence: [], accountToolPlan: null, handoffAvailable: false, refusalReason: null, suggestedTopics: [], provider: { provider: 'ollama' as const, model: 'qwen3:4b' as const, available: true } };
